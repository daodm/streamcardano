-- ~\~ language=Elm filename=src/Data/Query.elm
module StreamCardano.Data.Query exposing (Query, QueryResult(..), BlockNo, BlockId, decoder, encode)

{-| Using this module, you are able to decode Query data into an Elm record and encode Query record into JSON values.

# Definition
@doc Query, QueryResult, BlockNo, BlockId
